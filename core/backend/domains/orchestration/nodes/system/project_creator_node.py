...
class ProjectCreatorNode(BaseNode):
    ...
    async def on_enter(self):
        ...
        from shared.database import get_async_engine, get_async_session_maker, UserSettings
...
"""
    ...
    async def create_project(self, name: str, system_prompt: str) -> Dict[str, Any]:
        ...
        from shared.paths import get_project_dir, validate_name, update_project_name_cache as update_cache
        from sqlalchemy import select
