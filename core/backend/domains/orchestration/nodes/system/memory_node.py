...
from domains.orchestration.message import Message
import os
...
class MemoryNode(BaseNode):
    ...
    async def get_history(self, session_id: str) -> List[Message]:
        ...
        from shared.database import AsyncSessionLocal, ChatMessage, ChatSubMessage, ToolUsage
        from sqlalchemy import select
        from sqlalchemy.orm import selectinload, joinedload
        from domains.orchestration.message import Message, MessageRole, AttachedFile, ToolCall, SubMessage
    ...
    async def save_messages(self, session_id: str, messages: List[Message]):
        ...
        from shared.database import get_async_engine, get_async_session_maker, ChatMessage
        from uuid import uuid4
        from domains.orchestration.tools.utils import get_kc_service
        from domains.orchestration.message import MessageRole
        from shared.database import ToolUsage, ChatSubMessage
    ...
    async def get_or_create_session(self, project_id: str, user_id: str) -> str:
        ...
        from shared.database import AsyncSessionLocal, ChatSession
        from sqlalchemy import select
        from uuid import uuid4
