            ...
            {userMenuOpen && (
              <div className={`absolute bottom-full mb-2 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl py-1.5 z-[9999] ${primaryCollapsed ? "left-0 min-w-[220px]" : "left-3 right-3"}`}>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-start gap-3 px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
                >
