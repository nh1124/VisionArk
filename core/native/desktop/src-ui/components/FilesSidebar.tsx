...
// TODO: Create a simple MarkdownRenderer for Native or use a library
const MarkdownRenderer = ({ content }: { content: string }) => <div>{content}</div>;

// We will mock useNotification and useIsMobile for now to get it building
const useNotification = () => ({
    showConfirm: async (msg: string, opts: any) => window.confirm(msg),
