...
import { Mic, Square, Trash2, Check, Loader2, Volume2 } from "lucide-react";
            ...
            {audioBlob ? (
                ...
                <>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-bold text-white uppercase tracking-wider">Recording Ready</p>
                            <p className="text-[10px] text-gray-500 font-mono">{formatTime(recordingTime)}</p>
                        </div>
                    </div>
                ...
                <>
                    <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isRecording ? 'bg-red-500 animate-pulse' : 'bg-gray-800'}`}>
                        ...
                        <div>
                            ...
                            <p className={`text-[10px] font-mono ${isRecording ? 'text-red-400' : 'text-gray-500'}`}>
