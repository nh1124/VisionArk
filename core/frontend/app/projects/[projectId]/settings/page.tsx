...
export default function ProjectSettingsPage({
    ...
    const loadData = async () => {
        ...
        try {
            ...
            // Load Assigned Skills for this project (resolves to main agent automatically)
            const nodeSkillsRes = await apiFetch(`/api/skills/project/${projectId}`);
                    ...
                    <div className="max-w-4xl mx-auto">
                        {activeTab === "instructions" ? (
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                                    <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                                        <span className="text-cyan-500">◈</span> Agent Skills
                                    </h2>
                                    <span className="text-xs text-gray-500">Choose skills to attach to this agent</span>
                                </div>
