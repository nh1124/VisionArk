...
export default function ProjectSettingsPage({
    ...
    const loadPrompt = async () => {
        try {
            ...
            setSaveStatus("❌ Failed to load prompt");
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <div className="space-y-4">
                            ...
                            {isEditing ? (
                                <div className="space-y-4">
                                    ...
                                    />
                                    <div className="bg-cyan-900/10 border border-cyan-800/30 p-4 rounded-lg flex items-start gap-3">
                                        <span className="text-cyan-400 mt-0.5">💡</span>
                                        <div className="text-xs text-gray-400 leading-relaxed">
                                            <p className="font-bold text-cyan-400 mb-1">Writing Tips:</p>
                                            <ul className="list-disc list-inside space-y-1">
                                                <li>Define the agent's persona and tone</li>
                                                <li>Specify which tools or artifacts it should prioritize</li>
                                                <li>Describe the project's unique constraints or goals</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-900/30 border border-gray-800/50 rounded-2xl p-8 transition-all hover:bg-gray-900/40">
                                    {initialPrompt ? (
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-gray-700 text-xs mt-2">The agent is using default system settings.</p>
                                        </div>
                                    )}
                                </div>
                            )}
