"""Antigravity integration — service config helper."""
...
async def get_antigravity_config(user_id: str, db) -> dict | None:
    """Return service config dict if antigravity is active for this user, else None."""
    ...
    return {
        ...
        "default_timeout_sec": int(cfg.get("default_timeout_sec", 60)),
